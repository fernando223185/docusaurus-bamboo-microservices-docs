...
export default function UrlUpdateAlertEs(): JSX.Element {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <strong style={{ color: '#856404' }}>Actualización de URL:</strong>
            <span style={{ color: '#856404', marginLeft: '8px' }}>
              La URL base de la API ha sido actualizada a <code style={{ 
